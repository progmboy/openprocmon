...
#define IRP_MAP_DEF2(_x, _opt, _show, _psub) {(UCHAR)_x, _opt, _show, _psub}
...
OPT_FILE_OPERATOR_MAP gFileOptMap[] = {
	...
	IRP_MAP_DEF2(IRP_MJ_RELEASE_FOR_SECTION_SYNCHRONIZATION, TEXT("FASTIO_RELEASE_FOR_SECTION_SYNCHRONIZATION"), TEXT("FASTIO_RELEASE_FOR_SECTION_SYNCHRONIZATION"), NULL),
	IRP_MAP_DEF2(IRP_MJ_ACQUIRE_FOR_MOD_WRITE, TEXT("FASTIO_ACQUIRE_FOR_MOD_WRITE"), TEXT("FASTIO_ACQUIRE_FOR_MOD_WRITE"), NULL),
	IRP_MAP_DEF2(IRP_MJ_RELEASE_FOR_MOD_WRITE, TEXT("FASTIO_RELEASE_FOR_MOD_WRITE"), TEXT("FASTIO_RELEASE_FOR_MOD_WRITE"), NULL),
	IRP_MAP_DEF2(IRP_MJ_ACQUIRE_FOR_CC_FLUSH, TEXT("FASTIO_ACQUIRE_FOR_CC_FLUSH"), TEXT("FASTIO_ACQUIRE_FOR_CC_FLUSH"), NULL),
	IRP_MAP_DEF2(IRP_MJ_RELEASE_FOR_CC_FLUSH, TEXT("FASTIO_RELEASE_FOR_CC_FLUSH"),TEXT("FASTIO_RELEASE_FOR_CC_FLUSH"), NULL),
	IRP_MAP_DEF2(IRP_MJ_QUERY_OPEN, TEXT("FASTIO_NOTIFY_STREAM_FO_CREATION"), TEXT("FASTIO_NOTIFY_STREAM_FO_CREATION"), NULL),

	IRP_MAP_DEF(IRP_MJ_8, TEXT("IRP_MJ_8"), NULL),
	IRP_MAP_DEF(IRP_MJ_9, TEXT("IRP_MJ_9"), NULL),
	IRP_MAP_DEF(IRP_MJ_10, TEXT("IRP_MJ_10"), NULL),
	IRP_MAP_DEF(IRP_MJ_11, TEXT("IRP_MJ_11"), NULL),
	IRP_MAP_DEF(IRP_MJ_12, TEXT("IRP_MJ_12"), NULL),
				...
				if (gFileOptMap[i].pSubDesc) {
					...
					for (int j = 0; ; j++)
					{
						...
						if (pSubDesc[j].Minjor == 0xff ||
							...
							}else if (pFileOPt->Flags & FLTFL_CALLBACK_DATA_FAST_IO_OPERATION){
								lpszRet = pSubDesc[j].lpszFastIoName;
							}else{
								lpszRet = gFileOptMap[i].lpOptName;
							}
							break;
						}
					}
